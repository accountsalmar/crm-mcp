 ...
 */
export function getOdooUrl(id: number, model: 'crm.lead' | 'res.partner'): string {
  if (model === 'crm.lead') {
 ...
 */
export function formatLinkedName(id: number | undefined, name: string, model: 'crm.lead' | 'res.partner'): string {
